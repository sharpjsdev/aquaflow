...
export default function PendingReports({ navigation }) {
  ...
  const  realm = new Realm({
    ...
    useEffect(() => {
        if (isFocused) {
            ...
            var report_details = realm.objects('report_details').filtered('status = 0');
    ...
    return (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            <Appbar.Header style={{ backgroundColor: '#1c4468', marginTop: 24, width: '100%' }}>
                ...
                <Appbar.Content title="Pending Reports" />
                ...
                <List>
                    ...
                    <ListItem>
                        ...
                        <Body>
                            ...
                            <Text note>No Pending Reports Available.</Text>
                        </Body>
